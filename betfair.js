...
function DemoApiNgClient() {
  ...
  var options = {
    ...
    method: "POST",
    headers: {
      "X-Application": "Xvl0qwfmxnwAsTHE",
      Accept: "application/json",
      "Content-type": "application/json",
      "X-Authentication": "TLss7OypdP2gxrOU0Z7Jf2EUsfxspqYubkh8Ay4nmzk=",
    },
  };
  ...
  function retrieveEventId(response) {
    for (var i = 0; i <= Object.keys(response.result).length; i++) {
      console.log(response.result[i].eventType.name);
      if (response.result[i].eventType.name == "Special Bets") {
